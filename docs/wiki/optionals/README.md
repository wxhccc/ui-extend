...
``` js
// 引入cjs文件
import * as Optionals from '@wxhccc/ui-extends/lib/optionals'
// or 配置了node_modules内包也会解析的情况下
// import { createOption, dateFormatter } from '@wxhccc/ui-extends/src/optionals'
...
```html
<!-- 先引入其他脚本 -->
<script src="https://unpkg.com/@wxhccc/ui-extends/lib/optionals.min.js"></script>
...
```js
import { formatters } from '@wxhccc/ui-extends/lib/optionals'
...
```js
import { createOption } from '@wxhccc/ui-extends/lib/optionals'
...
```js
import { dateFormatter } from '@wxhccc/ui-extends/lib/optionals'
...
```js
import { createFormFieldItem } from '@wxhccc/ui-extends/lib/optionals'
...
```js
import { createFfiRulesProps } from '@wxhccc/ui-extends/lib/optionals'
...
```js
import { createInputFormItem } from '@wxhccc/ui-extends/lib/optionals'
