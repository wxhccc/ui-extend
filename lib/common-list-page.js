...
module.exports = require("ui-extend/lib/paged-table");
...
module.exports = require("ui-extend/lib/search-form");
...
// EXTERNAL MODULE: external "ui-extend/lib/paged-table"
var paged_table_ = __webpack_require__(11);
var paged_table_default = /*#__PURE__*/__webpack_require__.n(paged_table_);

// EXTERNAL MODULE: external "ui-extend/lib/search-form"
var search_form_ = __webpack_require__(34);
var search_form_default = /*#__PURE__*/__webpack_require__.n(search_form_);
...
const ueMethods = Object(component_["getPublicMethodNames"])(paged_table_default.a);
/* harmony default export */ var vindexvue_type_script_lang_js_ = ({
  name: 'UeCommonListPage',
  mixins: [component_storage_default()(), Object(component_["getComponentFnProxy"])(paged_table_default.a)],
  components: {
    [search_form_default.a.name]: search_form_default.a,
    [paged_table_default.a.name]: paged_table_default.a,
  ...
  props: { ...paged_table_default.a.props,
    rowKey: {
  ...
  computed: {
    ...
    pagedTableProps() {
      return Object(lodash_["pick"])(this.$props, Object.keys(paged_table_default.a.props));
    },
