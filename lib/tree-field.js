...
/* harmony default export */ var mainvue_type_script_lang_js_ = ({
  ...
  mixins: [ref_fn_proxy_default()('treeField', Object.keys(external_root_ELEMENT_commonjs_element_ui_commonjs2_element_ui_["Tree"].methods))],
  props: {
    inline: Boolean,
    nodeKey: {
      type: String,
        ...
        const getAccessItem = list => {
          ...
          list.forEach(item => {
            if (values.includes(item[nodeKey])) {
              let newItem = Object(lodash_["pickBy"])(item, (value, key) => key !== childrenKey);
...
// CONCATENATED MODULE: ./components/tree-field/main.vue?vue&type=script&lang=js&
 /* harmony default export */ var tree_field_mainvue_type_script_lang_js_ = (mainvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./components/tree-field/main.vue?vue&type=style&index=0&lang=scss&
var mainvue_type_style_index_0_lang_scss_ = __webpack_require__(70);
...
var component = Object(componentNormalizer["a" /* default */])(
  tree_field_mainvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* hot reload */
if (false) { var api; }
component.options.__file = "components/tree-field/main.vue"
...
/* harmony default export */ var tree_field = __webpack_exports__["default"] = (main);
