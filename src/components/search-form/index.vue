...
import { useStorage, useProxyInstanceMethods } from '@/hooks'
import { vueTypeProp } from '@/utils/component'
import UeFormFields from '../form-fields'
import { FormFieldsItem } from '../form-fields/types'
import { SearchFormPorps, SearchButtonOptions } from './type'
...
const props = defineProps({
  ...ueFormProps,
  items: vueTypeProp<SearchFormPorps['items']>(Array, () => [], true),
  modelValue: vueTypeProp<SearchFormPorps['modelValue']>(Object, () => ({})),
  searching: Boolean,
  buttonTrigger: vueTypeProp<boolean>(Boolean, true),
  showReset: Boolean,
  validateModel: Boolean,
  singleLine: Boolean,
  buttonOptions: vueTypeProp<SearchFormPorps['buttonOptions']>(Object),
  formRulesCreator: vueTypeProp<SearchFormPorps['formRulesCreator']>(Function),
  restore: Boolean,
  needStore: Boolean,
